...
btnEliminar.addEventListener("click", eliminarVideoxogo);
...
function eliminarVideoxogo() {
  ...
  let transaction=db.transaction("videoxogos", "readwrite");
  let almacen=transaction.objectStore("videoxogos");
